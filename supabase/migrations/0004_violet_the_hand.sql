...
ALTER TABLE "users_table" ADD COLUMN "emailVerified" timestamp;--> statement-breakpoint
...
ALTER TABLE "authenticator" ADD CONSTRAINT "authenticator_userId_users_table_id_fk" FOREIGN KEY ("userId") REFERENCES "public"."users_table"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
